...
async def post_image(request: Request) -> JSONResponse:
    try:
        ...
        prompt = f"""Generate a high-quality, photo-realistic image of a consumer electronics product named '{name}',
                    based on the following description: {description}.
                    The product should appear in modern, attractive packaging on a clean white background,
                    suitable for an online tech store like BestBuy."""
